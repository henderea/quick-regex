...
const helpText = new HelpTextMaker('quick-regex')
  ...
  .tab.tab.text('You can use the character case modification syntax with any other syntax setups. The case modification syntax goes immediately after the capture group number(s) from the basic syntax.').nl
  .nl
  .dict

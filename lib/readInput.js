...
let detectCharacterEncodingLib = false;
const detectCharacterEncoding = (...args) => {
    if(detectCharacterEncodingLib === false) {
        detectCharacterEncodingLib = require('detect-character-encoding');
    }
    return detectCharacterEncodingLib(...args);
};
